...
import timefold.ui.backend.vehiclerouting.domain.Location;
import timefold.ui.backend.vehiclerouting.domain.Vehicle;
import timefold.ui.backend.vehiclerouting.domain.VehicleRoutePlan;
import timefold.ui.backend.vehiclerouting.domain.Visit;
...
public class VehicleRouteDemoResource {
    ...
    public VehicleRoutePlan generate(DemoData demoData) {
    ...
    public enum DemoData {
        ...
        private final int minVehicleCapacity;
